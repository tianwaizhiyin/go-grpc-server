...
type ProdRequest struct {
	...
	ProdId   int32     `protobuf:"varint,1,opt,name=prod_id,json=prodId,proto3" json:"prod_id,omitempty"` //传入商品的ID
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x01, 0x43, 0x10, 0x02, 0x32, 0xea, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x65, 0x72,
	...
	0x74, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x49,
...
var file_Prod_proto_depIdxs = []int32{
	...
	1, // 4: services.ProdService.GetProdSInfo:input_type -> services.ProdRequest
	...
	5, // 7: services.ProdService.GetProdSInfo:output_type -> services.ProdModel
...
type ProdServiceClient interface {
	...
	GetProdSInfo(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProdModel, error)
}
...
func (c *prodServiceClient) GetProdSInfo(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProdModel, error) {
	out := new(ProdModel)
	err := c.cc.Invoke(ctx, "/services.ProdService/GetProdSInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProdServiceServer interface {
	...
	GetProdSInfo(context.Context, *ProdRequest) (*ProdModel, error)
}
...
func (*UnimplementedProdServiceServer) GetProdSInfo(context.Context, *ProdRequest) (*ProdModel, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProdSInfo not implemented")
}
...
func _ProdService_GetProdSInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProdServiceServer).GetProdSInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.ProdService/GetProdSInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProdServiceServer).GetProdSInfo(ctx, req.(*ProdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ProdService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetProdSInfo",
			Handler:    _ProdService_GetProdSInfo_Handler,
		},
	},
